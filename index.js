...
// Add an event listener to the sumbit button. Call handleSearchButtonClick when clicked
$searchBtn.addEventListener('click', handleSearchButtonClick)

// set ufoSighings to dataSet.
...
function handleSearchButtonClick(event){
	...
	ufoSightings = dataSet.filter(function(ufoData){
		//var ufoDataDate = ufoData.date_time.substring(0, filterDate_Time.length);
...
// Render for the first time table using the data from ufoSightings.
renderTable();